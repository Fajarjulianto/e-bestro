        ...
        <section className="px-6 md:px-12 pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="text-sm font-semibold text-black border-b pb-2 mb-4">Profile BESTRO</h3>
            ...
            <div className="bg-white rounded-lg shadow p-6 flex flex-col justify-between">
              <div>
                <h3 className="text-sm font-semibold text-black border-b pb-2 mb-4">Informasi Kontak</h3>
                <div className="space-y-4 text-sm text-gray-600">
