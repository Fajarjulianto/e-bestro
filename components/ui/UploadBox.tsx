    ...
    <div className="w-full">
      ...
      >
        ...
        {fileName ? (
          ...
          <>
            <p className="text-sm text-gray-700 font-semibold">Choose a file or drag & drop it here.</p>
            <p className="text-xs text-gray-500 mb-4">JPEG, PNG, and PDF formats, up to 5 MB.</p>
