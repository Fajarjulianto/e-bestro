...
const menuItems: MenuItem[] = [
  ...
  { label: 'Berkas Administrasi', href: '/dashboard/berkas', icon: <FiFileText /> },
  { label: 'Kalender Kegiatan', href: '/dashboard/kalender', icon: <FiCalendar /> },
  { label: 'Pelaporan Hasil Belajar', href: '/dashboard/khs', icon: <FiFileText /> },
  { label: 'Lapor Pembayaran UKT', href: '/dashboard/ukt', icon: <FiFileText /> },
  { label: 'Lapor Prestasi', href: '/dashboard/prestasi', icon: <FiFileText /> },
  { label: 'Lapor Perkembangan Diri', href: '/dashboard/perkembangan', icon: <FiFileText /> },
